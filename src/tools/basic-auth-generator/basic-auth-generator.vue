...
const { copy } = useCopy({ source: header, text: '请求头已复制到剪贴板' });
</script>

<template>
  <div>
    <c-input-text v-model:value="username" label="用户名" placeholder="请输入用户名..." clearable raw-text mb-5 />
    <c-input-text
    ...
    <c-card>
      <n-statistic label="Authorization 请求头：" class="header">
