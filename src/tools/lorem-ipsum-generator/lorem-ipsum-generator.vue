...
<template>
  <c-card>
    ...
    <n-form-item label="以 HTML 格式？" :show-feedback="false" label-width="200" label-placement="left">
      <n-switch v-model:value="asHTML" />
    </n-form-item>

    <c-input-text :value="loremIpsumText" multiline placeholder="您的 lorem ipsum 将显示在此..." readonly mt-5 rows="5" />
