...
<template>
  <div>
    <c-card>
      <c-input-text v-model:value="clearText" multiline raw-text placeholder="请输入要哈希的字符串..." rows="3" autosize autofocus label="您要哈希的文本：" />
      ...
      <c-select
        ...
        :options="[
          ...
          {
            label: 'Base64url (base 64 URL 安全字符)',
            value: 'Base64url',
          },
        ]"
      />
